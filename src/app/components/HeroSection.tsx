      ...
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        >
          ...
          <div className="grid min-[425px]:flex items-center">
            ...
            <a href="/curriculoAtualizado.pdf" download className="px-1 py-1 w-full sm:w-fit rounded-full bg-gradient-to-br from-blue-500 via-primary-500 to-secondary-500 hover:bg-slate-800 text-white mt-3 min-[425px]:mt-0">
